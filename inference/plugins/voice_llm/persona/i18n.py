...
CATALOGS: dict[str, dict[str, Any]] = {
    "zh-CN": {
        ...
        "artifact.null_search_line_2": "这份资料用于验证 CyberVerse Task Service、Pi SubAgent、事件流和 artifact 交付链路。",
    ...
    "en": {
        ...
        "artifact.null_search_line_2": "This artifact verifies the CyberVerse Task Service, Pi SubAgent, event stream, and artifact delivery path.",
    ...
    "ja": {
        ...
        "artifact.null_search_line_2": "この資料は CyberVerse Task Service、Pi SubAgent、イベントストリーム、artifact 配信経路を検証するためのものです。",
    ...
    "ko": {
        ...
        "artifact.null_search_line_2": "이 자료는 CyberVerse Task Service, Pi SubAgent, 이벤트 스트림, artifact 전달 경로를 검증하기 위한 것입니다.",
